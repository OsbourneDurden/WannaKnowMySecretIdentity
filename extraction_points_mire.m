...
% argument une matrice N*3 des points significatifs dans le repère monde 
...
if nargin == 1
    % Si on a pas de "points_monde", on demande à l'utilisateur le
    % nombre de point qu'elle contiendra
